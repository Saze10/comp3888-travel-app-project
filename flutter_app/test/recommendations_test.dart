...
Future<void> main() async {
  ...
  testWidgets('recommendations', (WidgetTester tester) async {
    await tester.pumpWidget(
        ScreenUtilInit(
          designSize: Size(1080, 1920),
          builder: () =>
              MaterialApp(
                  home: RecommendationsPage(userDestinationId:'default', auth: auth)
              ),
        )
    );
    await tester.idle();
    ...
    await tester.tap(find.widgetWithText(ButtonWidget,'Pick destination'));
    await tester.pump();
